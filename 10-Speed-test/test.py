...
heading_text = Label(speedTest, text="Welcome to the Internet Speed Tester", font=("Times New Roman", 16, "bold"), fg='white', bg='lightblue')    
...
result1 = Label(speedTest, textvariable=ping_Speed, font=("Times New Roman", 18, "italic"), bg="white")
result1.grid(row=3, column=1)
result2 = Label(speedTest, textvariable=down_Speed, font=("Times New Roman", 18, "italic"), bg="white")
...
# button
btn = Button(speedTest, text="Check Internet Speed", font=("Times New Roman", 18, "italic"), bg="white", border=5, command=speed_test)
